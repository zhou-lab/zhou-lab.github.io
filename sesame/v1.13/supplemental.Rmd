...
```{r nh11, fig.width=6, fig.height=8, eval=TRUE}
...
# KnowYourCG Visualization {#kycg_vis}
...
```{r ky10, echo=TRUE, eval=TRUE, message=FALSE}
library(SummarizedExperiment)
...
```{r ky20, plot-meta1, fig.width=5, fig.height=4, eval=TRUE}
sdf <- sesameDataGet("EPIC.1.SigDF")
...
``` {r ky24, echo=TRUE, eval=TRUE, message=FALSE}
library(SummarizedExperiment)
